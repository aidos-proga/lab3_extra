...
while True:
    ...
    if command == 0:
        ...
        if len(db) == 0:
            ...
            continue
        print('To see your balance type "balance" and number ')
        print('To convert balance type "convert" and number and type currency ')
        print('To withdraw money type "withdraw" and number and money ')
        print('To top up your balance type "add" and number and money ')
        print('To see info for u account type "info"  and your number ')
        print('To tranlate money someone type "translation" and number your account and number second account and money ')
        print('-'*43)
        cmd = input().split()
        if cmd[0] == 'balance':
